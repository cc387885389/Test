...
//	private static String passWord = res.getString("gpt.password");
	private static String url= "jdbc:mysql://115.29.137.138:3306/exhibition_hall?useUnicode=true&amp;charaterEncoding=utf8"; 
	private static String username ="exhibition_hall";
	private static String passWord ="123456";


	 //项目跟路径路径，此处修改为你的项目路径
	private static String rootPath ="D:\\Workspaces\\MyEclipse 8.6\\exhibition_hall\\" ;//"F:\\360云盘\\YiYaWork\\YIYA_SERVICE\\";//getRootPath();// "F:\\openwork\\open\\";
	private static String actionPath ="D:\\Workspaces\\MyEclipse 8.6\\exhibition_hall\\" ;//"F:\\360云盘\\YiYaWork\\YIYA_MS\\src\\com\\yiya\\ms\\";
	...
	public static void main(String[] args) {
		 ...
		 /** 此处修改成你的 表名 和 中文注释***/
		 String tableName="t_range_flow_info"; //
		 ...
		 String webPath = rootPath + "WebRoot\\view\\"; 
		 ...
		 String controllerPath = "ms\\action\\"+className+"Action.java";
